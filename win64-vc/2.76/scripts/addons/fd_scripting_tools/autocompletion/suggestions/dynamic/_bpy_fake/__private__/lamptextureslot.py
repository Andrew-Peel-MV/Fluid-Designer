...
class LampTextureSlot(bpy_struct):
    @property
    def rna_type(self):
    ...
    def object(self):
        ...
        return Object()
    @property
    def use_map_color(self):
        '''(Boolean) Let the texture affect the basic color of the lamp'''
        return bool()
    @property
    def use_map_shadow(self):
        '''(Boolean) Let the texture affect the shadow color of the lamp'''
        return bool()
    @property
    def color_factor(self):
        '''(Float) Amount texture affects color values'''
        return float()
    @property
    def shadow_factor(self):
        '''(Float) Amount texture affects shadow'''
        return float()