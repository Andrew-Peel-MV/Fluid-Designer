...
class Mask(bpy_struct):
    ...
    @property
    def layers(self):
        '''(Sequence of MaskLayer) Collection of layers which defines this mask'''
        return MaskLayers()
    @property
    def active_layer_index(self):
        '''(Integer) Index of active layer in list of all mask's layers'''
        return int()
    @property
    def frame_start(self):
        '''(Integer) First frame of the mask (used for sequencer)'''
        return int()
    @property
    def frame_end(self):
        '''(Integer) Final frame of the mask (used for sequencer)'''
        return int()
    @property
