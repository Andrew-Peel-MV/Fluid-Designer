...
class VertexPaint(bpy_struct):
    ...
    @property
    def use_normal(self):
        '''(Boolean) Apply the vertex normal before painting'''
        return bool()
    @property
    def use_spray(self):
        '''(Boolean) Keep applying paint effect while holding mouse'''
        return bool()
    @property
    def use_group_restrict(self):
        '''(Boolean) Restrict painting to vertices in the group'''
        return bool()