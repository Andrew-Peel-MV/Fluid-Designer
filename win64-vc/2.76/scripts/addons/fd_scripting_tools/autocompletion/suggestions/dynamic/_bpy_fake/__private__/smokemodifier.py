...
class SmokeModifier(bpy_struct):
    @property
    def rna_type(self):
    ...
    def domain_settings(self):
        '''(SmokeDomainSettings)'''
        return SmokeDomainSettings()
    @property
    def flow_settings(self):
        '''(SmokeFlowSettings)'''
        return SmokeFlowSettings()
    @property
    def coll_settings(self):
        '''(SmokeCollSettings)'''
        return SmokeCollSettings()
    @property
    def smoke_type(self):
        '''(Enum)
        
        [NONE, DOMAIN, FLOW, COLLISION]'''
        return str()